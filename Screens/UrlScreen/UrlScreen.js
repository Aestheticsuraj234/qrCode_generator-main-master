...
export default function UrlScreen() {
  ...
  const { generateQRCode, saveQRCode, QR, setInput, setQRref, setQR ,input} = useContext(QrCodeContext)
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.field}>
          <TextInput style={styles.input} cursorColor={'blueviolet'} selectionColor={'blueviolet'} value={input} onChangeText={setInput} placeholder='e.g https://www.google.com' />
