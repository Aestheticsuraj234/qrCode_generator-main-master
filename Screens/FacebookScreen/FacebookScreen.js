...
export default function FacebookScreen() {
  ...
  const { saveQRCode, QR,  setQRref, setQR ,facebookLink,setFacebookLink,generateFbQRCode} = useContext(QrCodeContext)
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.field}>
          <TextInput style={styles.input} cursorColor={'blueviolet'} selectionColor={'blueviolet'} value={facebookLink} onChangeText={setFacebookLink} placeholder='e.g https://www.facebook.com/profile.php?id=100082555962105' />
          <Pressable onPress={generateFbQRCode}>
