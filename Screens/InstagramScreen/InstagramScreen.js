...
export default function InstagramScreen() {
  ...
  const {  saveQRCode, QR,  setQRref, setQR , instagramLink , setInstagramLink , generateINSTAQRCode } = useContext(QrCodeContext)
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.field}>
          <TextInput style={styles.input} cursorColor={'blueviolet'} selectionColor={'blueviolet'} value={instagramLink} onChangeText={setInstagramLink} placeholder='e.g https://www.instagram.com/sigma_developer_/' />
          <Pressable onPress={generateINSTAQRCode}>
