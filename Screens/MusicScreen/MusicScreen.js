...
export default function MusicScreen() {
  ...
  const {  saveQRCode, QR, setInput, setQRref, setQR ,musicLink , setMusicLink,generateMusicQRCode} = useContext(QrCodeContext)
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.field}>
          <TextInput style={styles.input} cursorColor={'blueviolet'} selectionColor={'blueviolet'} value={musicLink} onChangeText={setMusicLink} placeholder='e.g https://open.spotify.com/track/0kzmBBR1Jjx5zBZKx9lsJr?autoplay=true' />
          <Pressable onPress={generateMusicQRCode}>
