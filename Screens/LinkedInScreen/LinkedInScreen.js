...
export default function LinkedInScreen() {
  ...
  const {  saveQRCode, QR,  setQRref, setQR , linkedIn , setLinkedIn  , generateLinkedInQRCode} = useContext(QrCodeContext)
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.field}>
          <TextInput style={styles.input} cursorColor={'blueviolet'} selectionColor={'blueviolet'} value={linkedIn} onChangeText={setLinkedIn} placeholder='e.g https://www.linkedin.com/in/suraj-jha-875744250/' />
          <Pressable onPress={generateLinkedInQRCode}>
