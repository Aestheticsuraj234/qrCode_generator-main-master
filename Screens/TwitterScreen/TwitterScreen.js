...
export default function TwitterScreen() {
  ...
  const {  saveQRCode, QR,  setQRref, setQR , twitterLink , setTwitterLink , generateTWQRCode } = useContext(QrCodeContext)
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.field}>
          <TextInput style={styles.input} cursorColor={'blueviolet'} selectionColor={'blueviolet'} value={twitterLink} onChangeText={setTwitterLink} placeholder='e.g https://twitter.com/i/flow/single_sign_on' />
          <Pressable onPress={generateTWQRCode}>
