...
export default function WhatsAppScreen() {
  ...
  const {  saveQRCode, QR,  setQRref, setQR ,whatsAppLink , setWhatsAppLink , generateWPQRCode} = useContext(QrCodeContext)
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.field}>
          <TextInput style={styles.input} cursorColor={'blueviolet'} selectionColor={'blueviolet'} value={whatsAppLink} onChangeText={setWhatsAppLink} placeholder='e.g https://web.whatsapp.com/' />
          <Pressable onPress={generateWPQRCode}>
